...
#define GLOBAL_CONFIG_FILE "/etc/crayonizer.conf"
#define USER_CONFIG_FILE ".crayonizer.conf"

typedef enum {NONE, BLACK, RED, GREEN, YELLOW, BLUE, MAGENTA, CYAN, WHITE, RESET, RESET2, DARKGREY, LIGHTRED, LIGHTGREEN, LIGHTYELLOW, LIGHTBLUE, LIGHTMAGENTA, LIGHTCYAN, LIGHTWHITE};
...
typedef enum {CRAYON_ACTION, CRAYON_ARGS, CRAYON_LINE, CRAYON_STRING, CRAYON_SECTION, CRAYON_LINENO, CRAYON_VALUE, CRAYON_MAPTO, CRAYON_LINEMAPTO, CRAYON_APPEND, CRAYON_PREPEND, CRAYON_EXEC, CRAYON_CMDLINE, CRAYON_PASSINPUT, CONFIG_INCLUDE, CONFIG_KEYPRESS, CRAYON_IF, CRAYON_STATUSBAR, CRAYON_COMPARATOR};
