...
//check if argument matches command-line argument
//this matches a single character command-line argument anywhere that it is found
//including if it is part of a string of such arguments.
...
//This function matches a 'long' command-line argument
...
static void ApplySingleAction(STREAM *Pipe, int *AttribLine, char *Line, int Len, const char *MatchStart, const char *MatchEnd, TCrayon *Action)
{
    int Attribs;
    int start, end, i, pos;
...
static void ProcessSubactions(STREAM *Pipe, int *AttribLine, char *Line, int Len, const char *MatchStart, const char *MatchEnd, TCrayon *Crayon)
{
    int i;
...
static int ProcessActionAndSubactions(STREAM *Pipe, int *AttribLine, char *Line, int Len, const  char *MatchStart, const char *MatchEnd, TCrayon *Crayon)
{
    int result=FALSE;
...
{
    char *p_SectionStart, *p_SectionEnd;
    const char *ptr;
    ...
    case CRAYON_SECTION:
        ...
        if ((p_SectionStart+Crayon->Len) > ptr) p_SectionEnd=(char *) ptr;
