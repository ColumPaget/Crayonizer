...
static void ParseFunctionKey(char *KeySym, int MaxLen, char *ModName, char K1, char K2)
{
    ...
    case '1':
        ...
        {
        case '1':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F1");
            break;
        case '2':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F2");
            break;
        case '3':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F3");
            break;
        case '4':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F4");
            break;
        case '5':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F5");
            break;
        case '7':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F6");
            break;
        case '8':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F7");
            break;
        case '9':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F8");
            break;
        }
        break;
    ...
    case '2':
        ...
        {
        case '0':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F9");
            break;
        case '1':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F10");
            break;
        case '3':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F11");
            break;
        case '4':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F12");
            break;
        case '5':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F13");
            break;
        case '6':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F14");
            break;
        case '8':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F15");
            break;
        case '9':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"menu");
            break;
        }
        break;
    ...
    case '3':
        ...
        {
        case '1':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F17");
            break;
        case '2':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F18");
            break;
        case '3':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F19");
            break;
        case '4':
            snprintf(KeySym,MaxLen,"%s%s",ModName,"F20");
            break;
        }
        break;
    }
    ...
    *ptr='\x1b';
    ...
    if (result > 0)
    {
        ...
        case 'O':
            ...
            {
            case 'A':
                strncpy(KeySym,"ctrl-up",MaxLen);
                break;
            case 'B':
                strncpy(KeySym,"ctrl-down",MaxLen);
                break;
            case 'c':
                strncpy(KeySym,"ctrl-left",MaxLen);
                break;
            case 'd':
                strncpy(KeySym,"ctrl-right",MaxLen);
                break;
            case 'P':
                strncpy(KeySym,"F1",MaxLen);
                break;
            case 'Q':
                strncpy(KeySym,"F2",MaxLen);
                break;
            case 'R':
                strncpy(KeySym,"F3",MaxLen);
                break;
            case 'S':
                strncpy(KeySym,"F4",MaxLen);
                break;
            }
        ...
        case '[':
            ...
            if (result > 0)
            {
                ...
                {
                case 'a':
                    strncpy(KeySym,"shift-up",MaxLen);
                    return(end-Sequence);
                    break;
                case 'b':
                    strncpy(KeySym,"shift-down",MaxLen);
                    return(end-Sequence);
                    break;
                case 'c':
                    strncpy(KeySym,"shift-right",MaxLen);
                    return(end-Sequence);
                    break;
                case 'd':
                    strncpy(KeySym,"shift-left",MaxLen);
                    return(end-Sequence);
                    break;
                case 'A':
                    strncpy(KeySym,"up",MaxLen);
                    return(end-Sequence);
                    break;
                case 'B':
                    strncpy(KeySym,"down",MaxLen);
                    return(end-Sequence);
                    break;
                case 'C':
                    strncpy(KeySym,"right",MaxLen);
                    return(end-Sequence);
                    break;
                case 'D':
                    strncpy(KeySym,"left",MaxLen);
                    return(end-Sequence);
                    break;
                case 'H':
                    strncpy(KeySym,"home",MaxLen);
                    return(end-Sequence);
                    break;
                case 'P':
                    strncpy(KeySym,"pause",MaxLen);
                    return(end-Sequence);
                    break;
                case 'F':
                    strncpy(KeySym,"end",MaxLen);
                    return(end-Sequence);
                    break;
                case 'Z':
                    strncpy(KeySym,"shift-tab",MaxLen);
                    return(end-Sequence);
                    break;
...
static int KeyPressRead(STREAM *StdIn, char **Data, char **KeySym, int MaxLen)
{
    ...
    *KeySym=SetStrLen(*KeySym,MaxLen);
    ...
    if (result > 0)
    {
        ...
        case '\x1b':
            result=ReadEscapeSequence(StdIn, *Data, *KeySym, MaxLen);
            break;
